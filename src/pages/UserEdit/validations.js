const rules = {
  ...
  specialist: {
    optional: { value: true, message: "specialist tidak boleh kosong." },
    maxLength: {
      value: 100,
      message: "specialist maksimal 100 karakter",
    },
    minLength: {
      value: 0,
      message: "Panjang 0 karakter",
  ...
  poliName: {
    optional: { value: true, message: "polyname tidak boleh kosong." },
    maxLength: {
      value: 100,
      message: "polyname maksimal 0 karakter",
    },
    minLength: {
      value: 0,
      message: "Panjang 0 karakter",
